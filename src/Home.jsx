...
const events = [
    {
        ...
        date: "28 / 06 / 2026",
        info: "Sign up on the official portal",
    },
    {
        side: "right",
        name: "Team Formation",
        date: "10 / 07 / 2026",
        info: "Build your squad of 2–4 members",
    },
    {
        side: "left",
        name: "Problem Statements",
        date: "20 / 07 / 2026",
        info: "Problem sets released to all teams",
    },
    {
        side: "right",
        name: "Round 1 — Prelims",
        date: "01 / 08 / 2026",
        info: "Online qualifying round",
    },
    {
        side: "left",
        name: "Round 2 — Semis",
        date: "10 / 08 / 2026",
        info: "Top 50 teams advance",
    },
    {
        side: "right",
        name: "Grand Finale",
        date: "16 / 08 / 2026",
        info: "Live event · ₹20 Lakh prize pool",
    },
];
        ...
        <section id="register" className="relative w-full">
            <div className="relative min-h-screen w-full bg-black overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center gap-10 mt-28">
                    ...
                    {/* LINE */}
                    <img src={line} alt="line" className="h-[420px] w-auto" />
    ...
    return (
        <main className="relative min-h-screen w-full overflow-x-hidden text-white">
            ...
            <div className="fixed inset-0 -z-50">
                <Dither
                    waveColor={[
                        0.9372549019607843, 0.9686274509803922,
                        0.24705882352941178,
                    ]}
